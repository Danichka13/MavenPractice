...
public class Search extends Operation {
    ...
    public void menuSearches() throws SQLException, IOException {
        ...
        while (flag) {
            System.out.println("""
                    Получить справочную информацию о наличии населенных пунктов,
    ...
    public ArrayList<String> searchByNameLocality() throws SQLException {
        ...
        System.out.println("\nВведите название населенного пункта(like запрос):");
        String nameLocality = scan.nextLine();
    ...
    public ArrayList<String> searchByPopulation() throws SQLException {
        ...
        double population = getNumber(str);
        ...
        while (resultSet.next()) {
            System.out.println("\t- " + resultSet.getString("TYPE") +
                    "  " + resultSet.getString("NAME") + " с населенеием " + resultSet.getString("POPULATION") + " тыс. человек");
            result.add(resultSet.getString("TYPE")
                    + " " + resultSet.getString("NAME")
                    + " с населенеием " + resultSet.getString("POPULATION") + " человек\n");
        }
        return result;
    }
    ...
    public ArrayList<String> searchByDate() throws SQLException {
        ...
        if (count == 0) {
            System.out.println("Города с такой датой нет!");
            result.add("Городов с такой датой нет!");
        }
        return result;
    }
    ...
    public ArrayList<String> searchByNameStreet() throws SQLException {
        ...
        if (count == 0) {
            ...
            result.add("Городов с такими именами улиц нет!");
        }
        return result;
    }
    ...
    public ArrayList<String> searchByTypeStreet() throws SQLException {
        ...
        if (count == 0) {
            System.out.println("Городов с такими типами улиц нет!");
            result.add("Городов с такими типами улиц нет!");
        }
        return result;
    }
