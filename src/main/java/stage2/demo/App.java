...
public class App {
    ...
    public static int menu() throws SQLException, IOException {
        ...
        System.out.println("""                                
                Выберите действие:
                1) Добавить Населённый пункт
                2) Добавить улицу в Населённый пункт
                3) Вывести все города
                4) Вывести все улицы населённого пункта
    ...
    public static void showStreet() throws SQLException {
        Scanner sc = new Scanner(System.in);
        System.out.println("Населённые пункты:");
        locality.showAll();
    ...
    public static void modifyInfo() throws SQLException {
        ...
        while (flag == 0) {
            System.out.println("""
                    ...
                    1) Информацию о населённом пункте
                    2) Информацию об улицах населённого пункта
                    0) Назад
                    """);
            switch (sc.nextLine()) {
                case "1": {
